...
export gitea_org=playground
export gitea_repos=(deployments)
export gitea_cache_tokens_base_dir="/tmp/gitea_tokens"

# exec_gitea() - Execute a command on a running Gitea Docker service
function exec_gitea {
...
# curl_gitea_api() - Send a cURL request to Gitea API
